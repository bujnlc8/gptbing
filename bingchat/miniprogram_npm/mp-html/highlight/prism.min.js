/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+ada+armasm+aspnet+awk+bash+basic+c+csharp+cpp+cilkc+cilkcpp+clojure+cmake+cobol+css-extras+dart+django+docker+dot+elixir+erlang+fortran+git+go+go-module+gradle+graphql+groovy+haskell+http+ignore+ini+j+java+javadoc+javadoclike+javastacktrace+json+jsonp+julia+keyman+kotlin+latex+less+lisp+lua+makefile+markdown+markup-templating+matlab+mongodb+nasm+nginx+nix+objectivec+ocaml+perl+php+plant-uml+puppet+python+r+jsx+tsx+regex+rest+ruby+rust+sass+scss+scala+scheme+solidity+sql+stylus+swift+toml+typescript+typoscript+uri+velocity+vim+wasm+wiki+wolfram+xml-doc+yaml+zig */
